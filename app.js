...
function sendto() {
  if (sending.src.match("/assets/joshua.png")) {
    ...
    setTimeout(function () {
      location.href = "/PageJordan1/jordan.html";
    }, 1000);
  } else if (sending.src.match("/assets/joey.png")) {
    setTimeout(function () {
      location.href = "/joey/joey.html";
    }, 1000);
